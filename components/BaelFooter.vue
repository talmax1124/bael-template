  ...
  <footer class="fill-gray-lighter xs-text-6 md-text-5">
    <div class="r no-gap">
      ...
      <div
        ...
        :class="signupAboutSize"
      >
      <a href="https://knighttimesnews.com"><p>Click Here To Go Back Home</p></a>
      </div>
      <div class="c-12 xs-text-left xs-p2 xs-border xs-border-right-none xs-border-bottom-none">
        <div class="item xs-text-6">
          <a href="https://github.com/jake-101/bael-template">Knight Times News</a>
          <span class="small-txt" v-if="version">{{version}}</span>, A Website Created By 
          <a href="https://linktr.ee/creativeduo2020">Creative Duo</a>
        </div>
      </div>
    </div>
  </footer>
